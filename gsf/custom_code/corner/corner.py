...
def corner(xs, bins=20, range=None, weights=None, color="k",
           ...
           max_n_ticks=5, top_ticks=False, use_math_text=False, alpha=1.0,
    ...
    **hist2d_kwargs
    ...
    fig.subplots_adjust(left=lb* 1.08, bottom=lb, right=tr, top=tr*1.02,
    ...
    for i, x in enumerate(xs):
        ...
        if smooth1d is None:
            n, _, _ = ax.hist(x, bins=bins[i], weights=weights,
                              range=np.sort(range[i]), lw=2., alpha=alpha, **hist_kwargs)
        else:
        ...
        for j, y in enumerate(xs):
            ...
            hist2d(y, x, ax=ax, range=[range[j], range[i]], weights=weights,
                   color=color, alpha=alpha, smooth=smooth, bins=[bins[j], bins[i]],
                   **hist2d_kwargs)
...
def hist2d(x, y, bins=20, range=None, weights=None, levels=None, smooth=None,
           ...
           contour_kwargs=None, contourf_kwargs=None, data_kwargs=None, alpha=1,
           **kwargs):
    """
    ...
    if plot_contours:
        ...
        ax.contour(X2, Y2, H2.T, V, linewidths=lw_cont, alpha=alpha, **contour_kwargs)
